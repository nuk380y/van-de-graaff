...
class TestHTMLNode(unittest.TestCase):
    def test_repr(self):
        ...
        expected_repr = (
            "HTMLNode('p', 'This is only a test', None, {'color': 'ffffff'})"
        )
        self.assertEqual(f"{node}", f"{expected_repr}")

    def test_to_html(self):
        node = HTMLNode("p", "This is only a test", None)
        expected_repr = "HTMLNode('p', 'This is only a test', None, None)"
        self.assertEqual(f"{node}", f"{expected_repr}")
    ...
    def test_props_to_html(self):
        ...
        expected_props = ' href="https://pypi.org" rel="noopener nofollower"'
...
class TestLeafNode(unittest.TestCase):
    ...
    def test_leaf_to_html_a(self):
        ...
        expected = '<a href="https://pypi.org">Python Package Index</a>'
        self.assertEqual(node.to_html(), expected)
...
class TestParentNode(unittest.TestCase):
    def test_to_html_with_children(self):
        child_node = LeadNode("span", "child")
